...
const article = {
    title: 'Analiza Pieței Imobiliare în Băicoi, Județul Prahova: Oportunități și Tendințe',
    slug: 'analiza-piata-imobiliara-baicoi-prahova',
    summary: 'Descoperă de ce orașul Băicoi din județul Prahova a devenit un punct de atracție major pentru investiții imobiliare. O analiză detaliată a prețurilor la case și terenuri în acest an.',
    content: `
    ...
    `,
    image_url: 'https://res.cloudinary.com/dwyztdtso/image/upload/v1784536179/samples/landscapes/nature-mountains.jpg', // A placeholder landscape
    meta_title: 'Piața Imobiliară Băicoi, Prahova - Analiză și Tendințe | Siena',
    meta_description: 'Află totul despre evoluția pieței imobiliare din Băicoi, Prahova. Prețuri, oportunități de investiții și tendințe pentru apartamente, case și terenuri.'
};
...
async function insertArticle() {
    ...
    try {
        ...
        await connection.execute(
            ...
            [article.title, article.slug, article.summary, article.content, article.image_url, article.meta_title, article.meta_description]
        );
