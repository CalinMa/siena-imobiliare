  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 pt-12 pb-20">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 prose prose-gray max-w-none">
          ...
          <h2>3. Politica de Prelucrare a Datelor (GDPR)</h2>
          <p>
            Conform Regulamentului (UE) 2016/679 (GDPR) privind protecția persoanelor fizice în ceea ce privește prelucrarea datelor 
            cu caracter personal, <strong>Siena Imobiliare</strong> se angajează să păstreze confidențialitatea datelor dumneavoastră.
          </p>
          
          <h3>3.1. Ce date colectăm?</h3>
          <p>
          ...
          <h3>3.2. În ce scop folosim datele?</h3>
          <p>
          ...
          <h3>3.3. Drepturile Dumneavoastră</h3>
          <p>
